...
import com.fighter.quickstop.lib.Sliding.OnClosedListener;
import com.fighter.quickstop.lib.Sliding.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	protected int mTouchMode = Sliding.TOUCHMODE_MARGIN;
	...
	public void scrollTo(int x, int y) {
	   ...
	   ((Sliding)getParent()).manageLayers(getPercentOpen());
	 ...
	 *
	 * @param v View to ToSearchActivity for horizontal scrollability
